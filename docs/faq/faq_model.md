...
https://github.com/erikh/go-swagger/blob/master/fixtures/codegen/existing-model.yml#L99-L103
...
Further, for repetitive customization, you might be willing to customize the generator's templates. Like in [here](https://github.com/erikh/go-swagger/blob/master/generator/templates/schemavalidator.gotmpl)
for models, or in [here](https://github.com/erikh/go-swagger/blob/master/generator/templates/server/parameter.gotmpl) for inline parameters.

Originally from issues [#997](https://github.com/erikh/go-swagger/issues/997) and [#1334](https://github.com/erikh/go-swagger/issues/1334)
...
Originally from issue [#959](https://github.com/erikh/go-swagger/issues/959). (*more discussion on edge cases there*).
...
Originally from issue [#990](https://github.com/erikh/go-swagger/issues/990).
...
Originally from issue [#932](https://github.com/erikh/go-swagger/issues/932).
...
Originally from issue [#643](https://github.com/erikh/go-swagger/issues/643).

### Accessing the Default return value
_Use-Case_: I was wondering how I would get the default response from the client?

Note: see also [Access HTTP status code from client#597](https://github.com/erikh/go-swagger/issues/597).
...
Originally from issue [#616](https://github.com/erikh/go-swagger/issues/616).
...
https://github.com/erikh/go-swagger/blob/master/fixtures/codegen/existing-model.yml#L99-103

Originally from issue [#948](https://github.com/erikh/go-swagger/issues/948).
...
Originally from issue [#1337](https://github.com/erikh/go-swagger/issues/1337).
...
Originally from issue [#1205](https://github.com/erikh/go-swagger/issues/1205).
...
Originally from issue [#1427](https://github.com/erikh/go-swagger/issues/1427).
...
Originally from issue [#1759](https://github.com/erikh/go-swagger/issues/1759).
...
Originally from issue [#1517](https://github.com/erikh/go-swagger/issues/1517).
