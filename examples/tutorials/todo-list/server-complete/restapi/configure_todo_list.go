...
import (
	...
	"github.com/erikh/go-swagger/examples/tutorials/todo-list/server-complete/models"
	"github.com/erikh/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations"
	"github.com/erikh/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations/todos"
)
