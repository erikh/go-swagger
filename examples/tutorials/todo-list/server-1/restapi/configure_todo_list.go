...
import (
	...
	"github.com/erikh/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/erikh/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
