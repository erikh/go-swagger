...
import (
	...
	"github.com/erikh/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/erikh/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
