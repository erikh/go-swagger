...
import (
	...
	"github.com/erikh/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/erikh/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
