...
import (
	...
	"github.com/erikh/go-swagger/examples/composed-auth/restapi/operations"

	auth "github.com/erikh/go-swagger/examples/composed-auth/auth"
	models "github.com/erikh/go-swagger/examples/composed-auth/models"
)
